...
public interface CsEnum{
    ...
    enum activiti{
        ...
        BUSINESS_KEY_APPLYROOM("0:FormKey:", " 0:FormKey: :代表会议申请,FormKey 表单ID + 表单Id，0：代表当前实例 是 样品申领流程"),
        BUSINESS_KEY_LEAVE("1:FormKey:", " 1:FormKey: :代表会议申请,FormKey 表单ID + 表单Id，1：代表当前实例 是 会议室流程"),
        //请假流程表达式判断
        Leave_FLAG("flag", "排他网管的表达式字符窜 flag=true"),
        Leave_FLAG_FALSE("false", "提交样品申领"),
        Leave_FLAG_TRUE("true", "放弃样品申领");
     ...
     */
    enum leavForm{
        Leave_status_GOING("1", "样品申领中"),
        Leave_status_succe("2", "样品申领成功"),
        Leave_status_false("3", "被拒绝样品申领"),
        Leave_FLAG_giveup("4", "放弃样品申领");
        private String value;
        private String descr;
