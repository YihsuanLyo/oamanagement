...
public class Thtask extends BasePo{
    private Integer id;
    ...
    public void setSubtaskId(Integer program)
    {
        this.subtaskId = program;
    }
    ...
    public void setSubtask(Subtask milestone)
    {
        this.subtask = milestone;
    }
